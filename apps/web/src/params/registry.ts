...
const textElementParams: ElementParamDefinition[] = [
	...
	// Outline and shadow geometry are fractions of the font size; the bounds
	// mirror Rust's text param validation.
	{
		key: "outline.enabled",
		label: "Outline Enabled",
		type: "boolean",
		default: DEFAULTS.text.outline.enabled,
		keyframable: false,
	},
	{
		key: "outline.color",
		label: "Outline Color",
		type: "color",
		default: DEFAULTS.text.outline.color,
		dependencies: [{ param: "outline.enabled", equals: true }],
	},
	{
		key: "outline.width",
		label: "Outline Width",
		type: "number",
		default: DEFAULTS.text.outline.width,
		min: 0,
		max: 0.5,
		step: 0.01,
		dependencies: [{ param: "outline.enabled", equals: true }],
