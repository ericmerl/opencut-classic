...
function createServer(): McpServer {
	...
	server.registerTool(
		...
		{
			description:
				"Atomically insert text, delete, move, retime, set validated element parameters, split, or trim timeline elements. Read the project first and use its current revision.",
