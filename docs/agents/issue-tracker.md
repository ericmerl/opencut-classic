...
Issues and PRDs for this repo live in GitHub Issues for `ericmerl/opencut-classic`. Use the `gh` CLI for all operations.
...
The target repository is `ericmerl/opencut-classic`, represented by the `origin` Git remote.
